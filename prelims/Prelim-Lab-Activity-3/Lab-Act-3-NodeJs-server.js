...
var server = http.createServer(function (req, res) {
  if (req.url == '/') {
    ...
    res.writeHead(200, { 'Content-Type': 'text/html' });
    res.write(
      '<html><body><p>This is about page Page.</p><p>Hello Miguel Enriquez, if you want additional details about this activity go to this site https://www.tutorialsteacher.com/nodejs/nodejs-tutorials</p></body></html>'
    );
    res.end();
